@extends('layouts.app')
@section('konten')
<div class="parallax align-middle shadow">
<div class="container h-100">
    <div class="row justify-content-center align-self-center">
   
        <div class="text-center text-dark my-5 animated fadeInRight">
        <br>
        <br>
        <br>
        <br>
        ...
        <br>
        <br>
        <h1 style="font-family: 'Anton', sans-serif; color:#2EA6E3;!important">Lorem ipsum dolor sit amet.</h1>
        <p style="font-size:25px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        <br>Nunc quam urna, dignissim nec auctor in, mattis vitae leo.</p>
        <button class="btn btn-primary btn-lg" type="button">Pelajari</button></div>
        </div>
   </div>
<style>
body, html {
...
.parallax {
  /* The image used */
  background-image: url('assets/img/tech/image6.jpg');
...
<main class="page landing-page">           
        <section class="clean-block clean-info dark bg-warning">
            <div class="container ">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6"><img class="img-thumbnail wow fadeInLeft" src="assets/img/scenery/image5.jpg"></div>
        ...
        <section class="clean-block features">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Mengapa menjadi<h2 style="color:#2EAAE8;">Lender</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo.</p>
                </div>
        ...
        <section class="clean-block features">
                <div class="container">
                    <div class="block-heading">
                        <h2 class="text-info">Mengapa menjadi Borrower</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo.</p>
